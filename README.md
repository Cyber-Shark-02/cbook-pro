# 📘 CBook Pro
### The Definitive Polyglot Notebook for VS Code
...
1.  **Install:** Get **CBook Pro** from the VS Code Marketplace.
2.  **Create:** Open a new file with the `.cbook` extension.
3.  **Code:**
    *   Click `+ Code` to add a cell.
    *   Select your language (bottom-right of the cell).
    *   Hit `▶` Run.
4.  **Toggle Modes:** Right-click a Python cell to switch between **Stateful** (Default) and **Stateless** (Isolated) modes.
